 ...
 * @since 2.6.0
 */
define( 'AUTH_KEY',         '^!|Kv^_F/^hM8khj:Ch*[Yj{6i:#8_TvLl3A--|5#RP D0^cAGz^Qf[YT4%2F|Pi' );
define( 'SECURE_AUTH_KEY',  'w(m:B)[~v(N^j8wF{r:+0J^.ISZtwD7puqz9KayGcQEI)67FkM>1!.I!^b&G8x/s' );
define( 'LOGGED_IN_KEY',    'l3~T~i+jdNFG>;$-vyA5$@2].rFf=dp,JDWAu>7rk#2*^OW,]l}UR81*OSn2K=_e' );
define( 'NONCE_KEY',        'SCiFNm^#Nq?3X>hzUo:`f@QIv[D<X+Jn>wm0IhX1>.IR@D.KY6<c.K0Uj0-YZht{' );
