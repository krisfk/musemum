                        ...
                        <div class="scene-div scene-div-2">
                                ...
                                <div class="scene-2-screen-2-slide">
                                    <div class="event-div one-col-width">
                                        ...
                                        <div class="event-content-div"
                                            style="background:<?php echo get_sub_field('screen_2_left_event_content_background_color');?>;">
                                    ...
                                    <div class="event-div one-col-width">
                                        ...
                                        <div class="event-content-div"
                                            style="background:<?php echo get_sub_field('screen_2_right_event_content_background_color');?>;">
                                            <div style=" width: 530px; ">
                            ...
                            if(get_field('screen_3_mode')=='event slides')
                            {
                                ...
                                <div class="scene-2-screen-3-slide">
                                    ...
                                    <div class="event-div one-col-width">
                                        <div class="event-title-div"
                                            style="background:<?php echo get_sub_field('screen_3_right_event_title_background_color');?>">
                                            <div>
                        ...
                        <div class="scene-div scene-div-3">
                            ...
                            <div class="scene-3-screen scene-3-screen-1">
                                ...
                                <div class="publication-div-bg"
                                    style="width:640px;background:url(<?php echo wp_get_attachment_image_src(get_field('content_1',186),'full')[0];?>)">
                                ...
                                <?php echo get_field('screen_1_book_3',233);?>
                                <?php echo get_field('screen_1_book_2',233);?>
                                <?php echo get_field('screen_1_book_1',233);?>
                        ...
                        <div class="scene-div scene-div-4">
                            ...
                            <div class="scene-4-screen scene-4-screen-1">
                                ...
                                <img class="now-weather-icon"
                                    src="<?php echo wp_get_attachment_image_src(get_field('content_1',186),'full')[0];?>"
                                    alt="">
                        ...
                        <div class="scene-div scene-div-6">
                            ...
                            <div class="scene-6-screen scene-6-screen-2">
                                ...
                                <video class="mcd-logo-video" loop>
                                    <source src="<?php echo wp_get_attachment_url(get_field('content_2',199));?>"
                                        type="video/mp4">
                                </video>
