    ...
    <div class="scene-div scene-div-1">
        ...
        <div class="iphone-div">
            ...
            <video class="iphone-video" controls>
                <source src="http://64.227.13.14/musemum/wp-content/uploads/2022/05/Checkpoint11_UI_crop.mov"
                    type="video/mp4">
            </video>
        ...
        <div class="ar-videos-div">
            ...
            <video class="ar-video ar-video-2" controls>
                <source src="http://64.227.13.14/musemum/wp-content/uploads/2022/05/video_preview_h264.mp4"
                    type="video/mp4">
            </video>

            <video class="ar-video ar-video-3" controls>
                <source src="http://64.227.13.14/musemum/wp-content/uploads/2022/05/video_preview_h264-1.mp4"
                    type="video/mp4">
            </video>
        ...
        <div class="scene-2-screen scene-2-screen-1">
            ...
            <div class="scene-2-txt-1" style="font-size: 100px; display: block;">
                ...
                <span class="roboto" style="font-size: 84px;margin: 0 0 0 70px;">Get different learning
                    experience</span><br>
                <span class="roboto" style="font-size: 84px;margin: 0 0 0 124px;"> through the programmes</span>
            </div>
    ...
    <div class="scene-div scene-div-6">
        ...
        <div class="scene-6-screen scene-6-screen-2">
            ...
            <div class="scene-6-screen-2-txt">
                • 預防新型冠狀病毒在社區傳播<br>
                • 本博物館採取以下防疫措施以保障公眾健康<br>
                • 訪客進館前須佩戴口罩，以保障公眾及員工健康<br>
                • 我們為所有進入博物館的人士及工作人員量度體溫<br>
                多謝合作
                • Help prevent the Novel Coronavirus from spreading in the community<br>
                • Our museum implements the following precaution measures<br>
                • It is essential for visitor to wear masks upon entry the museum to safeguard the health of visitors
                and staff members<br>
                • We arrange temperature check for all visitors and staff who enter the museum
